...
const heroSlides = [
    "/images/products/Products-Shoot-2-scaled.webp",
    "/images/products/57189.webp",
];
...
const features = [
    {
        ...
        text: "Charge during shift breaks to avoid downtime — no need for battery changeover.",
    },
    {
        icon: TrendingUp,
        title: "Long Life = High ROI",
        text: "Up to 4000 cycles, significantly outlasting lead-acid batteries in industrial use.",
    },
    {
        icon: Cpu,
        title: "Smart BMS with Real-Time Communication",
        text: "Communicates over CAN/RS485 to track battery health, state of charge, temperature, and diagnostics.",
    },
    {
        icon: Wrench,
        title: "Zero Maintenance",
        text: "No acid spillage, no corrosion, no water refilling — fully sealed & maintenance-free.",
    },
    {
        icon: Thermometer,
        title: "Performs in Extreme Conditions",
        text: "Designed to operate efficiently in cold storage, high-heat zones, or 24×7 logistics warehouses.",
    },
];

const upgradeReasons = [
    "Reduced energy costs",
    "24/7 operation with opportunity charging",
    "Custom-built packs for OEM or retrofit",
    "Built to withstand shocks, vibrations, and tough handling",
];

const applications = [
    { icon: Truck, title: "Electric Forklifts (3-Wheel & 4-Wheel)" },
    { icon: PackageSearch, title: "Reach Trucks & Order Pickers" },
    { icon: Warehouse, title: "VNA Equipment (Very Narrow Aisle Trucks)" },
    { icon: Boxes, title: "Pallet Stackers & Electric Pallet Trucks" },
    { icon: MoveHorizontal, title: "Tow Tractors & Tuggers" },
    { icon: Bot, title: "Automated Guided Vehicles (AGVs) & Robots" },
];

const specs = [
    { param: "Battery Type", value: "LiFePO₄ – Prismatic" },
    { param: "Nominal Voltages", value: "24V / 36V / 48V / 72V / 80V / 96V" },
    { param: "Capacity Range", value: "100Ah to 600Ah (custom solutions available)" },
    { param: "Cycle Life", value: "3000–5000+ Cycles" },
    { param: "Peak Discharge Rate", value: "Up to 3C Pulse Current" },
    { param: "Charging Time", value: "1–2 Hours (Fast Charge Capable)" },
    { param: "Communication", value: "CAN Bus / RS485 / Modbus" },
    { param: "Certifications", value: "ISO" },
...
export default function MHEBattery() {
                ...
                <section className="relative overflow-hidden">
                  ...
                  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
                    ...
                    >
                      ...
                      <span>Product</span>
                      <ChevronRight size={16} />
                      <span className="text-[#FFB600] font-semibold">MHE Battery</span>
                    </motion.div>
                    ...
                    >
                      ...
                      <span className="text-[#FFB600]">MHE Battery</span>
                    </motion.h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h1 className="mt-2 text-3xl sm:text-4xl font-bold text-[#0A528F] leading-tight">
                            Arenq Lithium Batteries for Material Handling
                            Equipment (MHE)
                        </h1>

                        <p className="mt-5 text-gray-600 leading-8">
                            <strong>Arenq</strong>, a premium battery brand by{" "}
                            ...
                            for a wide range of{" "}
                            <strong>Material Handling Equipment (MHE)</strong>{" "}
                            including electric forklifts, pallet stackers,
                            reach trucks, tow tractors, and order pickers.
                        </p>
                        <p className="mt-4 text-gray-600 leading-8">
                            Our batteries are engineered for demanding
                            industrial operations, delivering{" "}
                            <strong>high energy density</strong>,{" "}
                            <strong>long runtime</strong>,{" "}
                            <strong>zero maintenance</strong>, and{" "}
                            <strong>fast charging</strong> — with the added
                            assurance of maximum safety and compliance.
                        </p>
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-6">
                            ...
                            <a
                                href="/images/brochure/MHE-Battery.pdf"
                                target="_blank"
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6">
                    ...
                    >
                        ...
                        <h2 className="mt-3 text-2xl sm:text-3xl font-bold text-[#0A528F]">
                            Upgrade to Lithium, Upgrade to Arenq
                        </h2>
                    </motion.div>
            ...
            <section className="py-16 sm:py-24 bg-gray-50">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#0A528F]">
                        Ready to modernize your warehouse fleet?
                    </h2>
                    <p className="mt-4 text-gray-500">
                        Talk to our team about voltage, capacity, and retrofit
                        options for your material handling equipment.
                    </p>
                    <motion.a
                        href="/contact-us/"
                        whileHover={{ scale: 1.05 }}
