...
const heroSlides = [
    ...
    "/images/products/Products-Shoot-28-scaled.webp",
...
const features = [
    {
        ...
        text: "Safer, longer-lasting, and more efficient than traditional battery types.",
    },
    {
        icon: ShieldCheck,
        title: "Instant Backup Power",
        text: "Supports fast discharge and recharge, ensuring reliable operation during power interruptions.",
    },
    {
        icon: Cpu,
        title: "Advanced Battery Management System",
        text: "(BMS) Monitors voltage, current, temperature, and protects against overcharge/discharge and short circuits.",
    },
    {
        icon: Wrench,
        title: "Maintenance-Free Operation",
        text: "No water topping, corrosion, or frequent servicing — reduces total cost of ownership.",
    },
    {
        icon: Leaf,
        title: "Eco-Friendly & Recyclable",
        text: "Lead-free, RoHS compliant, and designed for a greener tomorrow.",
    },
];
...
const applications = [
    ...
    { icon: Gauge, title: "Grid Peak Shaving & Load Balancing" },
];
...
const specs = [
    ...
    { param: "Backup Time", value: "10 min to 2 hours (customizable)" },
    { param: "Communication", value: "RS485 / CAN / Modbus" },
    { param: "Life Cycle", value: "3000 – 5000+ Cycles" },
    { param: "Certification", value: "ISO 9001, ISO 14001" },
    { param: "Cooling", value: "Passive or Active (as required)" },
];
...
export default function IndustrialUpsBattery() {
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
                    ...
                    >
                        ...
                        <span>Product</span>
                        <ChevronRight size={16} />
                        <span className="text-[#FFB600] font-semibold">Industrial UPS Battery</span>
                    </motion.div>
                    ...
                    >
                        ...
                        <span className="text-[#FFB600]">Industrial UPS Applications.</span>
                    </motion.h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h1 className="mt-2 text-3xl sm:text-4xl font-bold text-[#0A528F] leading-tight">
                            Arenq Lithium Batteries for Industrial UPS
                            Applications
                        </h1>

                        <p className="mt-5 text-gray-600 leading-8">
                            At <strong>Arenq</strong>, we deliver
                            next-generation{" "}
                            <strong>Lithium Iron Phosphate (LiFePO₄)</strong>{" "}
                            battery systems designed specifically for{" "}
                            <strong>
                                Industrial Uninterruptible Power Supply (UPS)
                            </strong>{" "}
                            applications. Our batteries ensure{" "}
                            <strong>instant backup</strong>,{" "}
                            <strong>longer service life</strong>, and{" "}
                            <strong>high energy efficiency</strong>, making them
                            the ideal replacement for traditional lead-acid
                            batteries in mission-critical environments.
                        </p>
                        <p className="mt-4 text-gray-600 leading-8">
                            Arenq UPS batteries offer industry-leading safety,
                            performance, and sustainability — all in a compact
                            and maintenance-free package.
                        </p>
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-6">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.97 }}
                                className="inline-flex items-center gap-2 px-6 py-2 rounded-full font-semibold text-white shadow-lg"
                                style={{
                                    backgroundImage:
                            ...
                            <a
                                href="/images/brochure/UPS-Battery.pdf"
                                target="_blank"
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6">
                    ...
                    >
                        ...
                        <h2 className="mt-3 text-2xl sm:text-3xl font-bold text-[#0A528F]">
                            Why Industries are Switching to Arenq UPS
                            Batteries?
                        </h2>
                    </motion.div>

                    <div className="grid sm:grid-cols-2 gap-4 mt-10">
                        {whySwitching.map((item, i) => (
                            <motion.div
                                key={item}
            ...
            <section className="py-16 sm:py-24 bg-gray-50">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#0A528F]">
                        Ready to upgrade your UPS backup?
                    </h2>
                    <p className="mt-4 text-gray-500">
                        Talk to our team about capacity, voltage configuration,
                        and lead times for your facility.
                    </p>
                    <motion.a
                        href="/contact-us/"
                        whileHover={{ scale: 1.05 }}
