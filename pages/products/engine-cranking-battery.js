...
const heroSlides = [
  "/images/products/Cranking-App-1-1-scaled.webp",
  "/images/products/Cranking-App-2-1-scaled.webp",
  "/images/products/969.webp",
];

const features = [
  {
    icon: Zap,
    title: "High Pulse Discharge",
    text: "Delivers up to 5C–10C discharge current, enabling quick and powerful engine starts.",
  },
  {
    icon: Repeat,
    title: "Long Service Life",
    text: "Offers 2000+ cycles, much higher than conventional starter batteries.",
  },
  {
    icon: Wrench,
    title: "Maintenance-Free Design",
    text: "No acid spills, corrosion, or water refilling — sealed, safe, and ready to use.",
  },
  {
    icon: CloudSun,
    title: "All-Weather Performance",
    text: "Performs efficiently in extreme heat, cold, or dusty environments.",
  },
];

const integrationOptions = [
  "Built-in cold weather heating pads (optional)",
  "IP-rated enclosures for harsh environments",
  "Drop-in replacement for lead-acid starter batteries",
  "Smart relay or starter interlock with BMS control",
];

const applications = [
  { icon: Fuel, title: "Diesel Generator Starting (DG Sets)" },
  { icon: HardHat, title: "Construction & Mining Equipment" },
  { icon: Anchor, title: "Marine Engines (Boats/Yachts)" },
  { icon: Truck, title: "Trucks, Buses & Heavy Commercial Vehicles" },
  { icon: Wheat, title: "Agricultural Tractors & Combines" },
  { icon: Shield, title: "Military & Defense Vehicle Platforms" },
];

const specs = [
  { param: "Battery Type", value: "LiFePO₄ (Lithium Iron Phosphate)" },
  { param: "Nominal Voltage", value: "12.8V / 24V / 48V" },
  { param: "Capacity Range", value: "40Ah – 200Ah" },
  { param: "Peak Cranking Current", value: "Up to 2000A (customizable)" },
  { param: "Continuous Discharge", value: "3C to 10C pulse current" },
  { param: "Communication", value: "Optional CAN / RS485" },
...
export default function EngineCrankingBattery() {
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
          ...
          >
            ...
            <span>Product</span>
            <ChevronRight size={16} />
            <span className="text-[#FFB600] font-semibold">Engine Cranking Battery</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-[#FFB600]">Engine Cranking Applications</span>
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatePresence mode="sync">
              ...
              >
                <Image
                  ...
                  alt="Arenq Engine Cranking Battery"
                  fill
          ...
          >
            ...
            <h1 className="mt-2 text-3xl sm:text-4xl font-bold text-[#0A528F] leading-tight">
              Arenq Lithium Batteries for Engine Cranking
              Applications
            </h1>

            <p className="mt-5 text-gray-600 leading-8">
              <strong>Arenq</strong>, the power brand by{" "}
              <strong>Sunlit Power Pvt. Ltd.</strong>, offers{" "}
              <strong>
                high-discharge Lithium Iron Phosphate (LiFePO₄)
                batteries
              </strong>{" "}
              specifically designed for{" "}
              <strong>engine cranking and starting applications</strong>.
              Built for instant, high-current output, these
              batteries ensure{" "}
              <strong>fast and reliable ignition</strong> for diesel
              and petrol engines — across a wide range of
              commercial, industrial, and off-grid use cases.
            </p>
            <p className="mt-4 text-gray-600 leading-8">
              Arenq cranking batteries combine{" "}
              <strong>safety</strong>, <strong>reliability</strong>,
              and <strong>durability</strong>, making them an ideal
              upgrade over traditional lead-acid starter batteries.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6">
              ...
              <a
                href="/images/brochure/Engine-Cranking.pdf"
                target="_blank"
      ...
      <section className="py-16 sm:py-24 bg-gray-50">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-[#0A528F]">
            Need reliable starting power for your fleet or equipment?
          </h2>
          <p className="mt-4 text-gray-500">
            Talk to our team about voltage, capacity, and enclosure
            options for your cranking application.
          </p>
          <motion.a
            href="/contact-us/"
            whileHover={{ scale: 1.05 }}
