...
import OrderTrackingPremium from "./OrderTrackingPremium";
...
const OrderDetail = ({ order, shipping_address, user }) => {
  ...
  useEffect(() => {
    const loadTracking = async () => {
      const res = await fetch(`/api/order-tracking/${order._id}`);
      const data = await res.json();
      if (data?.available) setTracking(data);
    };
    loadTracking();
  }, [order._id]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen md:w-5/6 mx-auto p-5">
       ...
       {tracking && <OrderTrackingPremium tracking={tracking} />}
              ...
              <div key={item._id}>
                <div className="w-full bg-white   border">
                  <div className="p-2 py-5 flex flex-wrap justify-center items-center">
                    ...
                    <div className="hidden md:block w-full md:w-2/3 pt-10 pb-5  items-center justify-center relative mt-5">
                      <ol className="flex items-center w-4/5 mx-auto mb-4 sm:mb-5">
                        <li
                          className={`flex w-full relative items-center text-black dark:text-black after:content-[''] after:w-full after:h-1 after:border-b ${check_delivery_status(
                            "order_confirmed",
                            item.delivery_status
                          ) && "after:border-green-300"
                            } after:border-4 after:inline-block ${check_delivery_status(
                              "order_confirmed",
                              item.delivery_status
                        ...
                        >
                          <span
                            className={`absolute -top-5 -left-6 font-medium text-sm ${check_delivery_status(
                              "order_confirmed",
                              item.delivery_status
                            ) && "text-green-500"
                              }`}
                          ...
                          <div
                            className={`flex items-center justify-center w-5 h-5 ${check_delivery_status(
                              "order_confirmed",
                              item.delivery_status
                            ) && "bg-green-300"
                              } rounded-full lg:h-8 lg:w-8 ${check_delivery_status(
                                "order_confirmed",
                                item.delivery_status
                              ) && "dark:bg-green-800"
                              } shrink-0`}
                        ...
                        >
                          <span
                            className={`absolute -top-5 -left-2 font-medium text-sm ${check_delivery_status(
                              "shipped",
                              item.delivery_status
                            ) && "text-green-500"
                              }`}
                        ...
                        >
                          <span
                            className={`absolute -top-5 -left-7 font-medium text-sm ${check_delivery_status(
                              "out_for_delivery",
                              item.delivery_status
                            ) && "text-green-500"
                              }`}
                        ...
                        <li className="flex relative items-center ">
                          <span
                            className={`absolute -top-5 -left-3 font-medium text-sm ${check_delivery_status(
                              "delivered",
                              item.delivery_status
                            ) && "text-green-500"
                              }`}
                  ...
                  <div className="md:hidden border-b-0 border-l-0 border-r-0 border border-gray-200 w-full">
                    ...
                    <ol
                      className={`${isOpen ? "d-block" : "hidden"
