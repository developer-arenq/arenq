...
const BestSeller = () => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("/api/products/featured/best_seller");
      ...
      <div className="relative mx-auto w-[100%] lg:w-[95%] max-w-[1400px] px-2 py-6">
        ...
        <div className="w-full flex items-center justify-between gap-2">
          <div className="flex-1 flex justify-start">
            <h2 style={{ fontFamily: 'var(--font-body)' }} className="text-[18px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold text-[#2d241b] whitespace-nowrap leading-tight tracking-wide">
              Best Sellers
            </h2>
          </div>
