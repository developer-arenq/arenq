...
const SkinCare = () => {
 ...
 useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      try {
        const res = await fetch("/api/products/name/care");
  ...
  const scrollToPage = (page) => {
    if (scrollRef.current) {
      ...
      const scrollAmount = containerWidth * page;
  ...
  return (
    <>
      <div className="mx-auto pt-5 py-0 px-2 lg:px-2 sm:px-0 md:px-0 max-w-full">
          ...
          {loading
            ...
            : products.map((product, index) => {
                ...
                return (
                  ...
                  >
                    <button
                      className={`absolute z-10 top-2 right-2 p-2 bg-white border border-gray-300 rounded-full hover:border-black touch-manipulation ${
                      ...
                      <div className="cursor-pointer relative">
                        ...
                        <div className="relative overflow-hidden rounded-md">
                          <Image
                            ...
                            alt={
                              product?.alt_text || product?.name || "Product Image"
                            }
                            width={600}
                            height={600}
                            objectFit="cover"
