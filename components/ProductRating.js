              ...
              <div className="leading-5">
                ...
                reviews.filter(
                  ...
                  <button
                    ...
                    className=" px-10 py-2 font-sans uppercase transition-all duration-300 hover:bg-black hover:text-white text-sm font-bold w-full mt-2 border-2 border-black"
                  >
                    Write Review
                  </button>
                )}
